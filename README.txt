...
2. Установка
   ...
   3) Если установка зависимостей по каким-либо причинам завершилась неудачей:
      а) Перезапустить installer.bat из командной строки, запущенной от имени администратора,
