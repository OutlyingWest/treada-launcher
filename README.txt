...
5. Дополнительные возможности
   ...
   *В скобках (--example) указаны дополнительные аргументы, которые могут быть использованы в комбинации с основными.
   --plot-res                       - Построение диаграмм результатов расчета переходного процесса.
   --collect-distr (--gui)          - Построение диаграмм распределений различных величин из временных WW файлов,
   ...
   --plot-fields-integral           - Построить интеграл полей для последней точки первого этапа работы
                                      и последней точки второго.
